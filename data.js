...
function readFormData() {
    ...
    formData["county"] = document.getElementById("country").value;
    return formData;
...
function insertNewRecord(data) {
    ...
    cell8.innerHTML = '<a onclick="Edite(this)" class="text-center text-white btn">Edite</a>';
    cell9 = newRow.insertCell(8);
    cell9.innerHTML = '<a onclick="onDelete(this)" class="text-center text-white btn">delete</a>';
    selectedRow = null;
}
